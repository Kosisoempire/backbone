...
router.post("/results", async (req, res) => {
  ...
  try {
    ...
    const resultRef = doc(db, "Results", regUpper); // <--  Document ID = regNumber

    // Try fetching the document to see if it exists
    ...
    res.status(200).json({ message: "Result saved", resultId: regUpper });
